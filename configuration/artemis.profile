...
ARTEMIS_INSTANCE='/home/jboss/brokers2i'
...
ARTEMIS_INSTANCE_URI='file:/home/jboss/brokers2i/'
ARTEMIS_INSTANCE_ETC_URI='file:/home/jboss/brokers2i/etc/'
...
# Java Opts
JAVA_ARGS="-Djava.net.preferIPv4Stack=true -XX:+UnlockExperimentalVMOptions -XX:+UseCGroupMemoryLimitForHeap   -XX:MinHeapFreeRatio=10 -XX:MaxHeapFreeRatio=20 -XX:GCTimeRatio=4 -XX:AdaptiveSizePolicyWeight=90 -XX:MaxMetaspaceSize=100m -XX:+ExitOnOutOfMemoryError -XX:+PrintClassHistogram -XX:+UseG1GC  -Dhawtio.realm=activemq  -Dhawtio.offline="true" -Dhawtio.roles=admin,amq,guest -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml -Djon.id=amq"
